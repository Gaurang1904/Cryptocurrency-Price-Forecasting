...
def load_and_prepare_data(file_path):
    """Load and prepare the Ethereum dataset with additional features for TFT"""
    ...
    exog_features = [
        'Open', 'High', 'Low', 'Volume', 'active_addresses', 'eth_transferred',
        'total_gas_used', 'RSI_14', 'MACD_diff', 'EMA_9', 'EMA_21', 'ATR_14', 
...
def export_predictions_to_csv(results, filename="eth_tft_predictions.csv"):
...
def plot_predictions(results):
    ...
    ax1.set_title('Actual vs Predicted Ethereum Prices (TFT Model)', fontsize=16, fontweight='bold', pad=20)
...
def main():
    ...
    export_df = export_predictions_to_csv(results, "ethereum_tft_predictions.csv")
